...
var resizePizzas = function(size) {
    ...
    function changePizzaSizes(size) {
        // Created a new variable allPizzaContainers for all pizza containers to apply dx and newwidth to all pizza containers;
        // Placed all variables out of the for loop.
        ...
        var lenght = allPizzaContainers.length;
